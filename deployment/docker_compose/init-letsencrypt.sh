...
$COMPOSE_CMD -f docker-compose.prod.yaml run  --name pytupli-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yaml -p pytupli-stack --profile with_mongo up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yaml -p pytupli-stack --profile with_mongo up --force-recreate -d
